    ...
    <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-slate-700 md:text-4xl lg:text-7xl dark:text-slate-300">
          {"Predict the future with real-time on-chain data"
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
        ...
        >
          Gen Predicts is a prediction market built on GenLayer. Place bets on events, get instant updates, and
          trade predictions with real-time on-chain data.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
        ...
        >
          <div className="w-full overflow-hidden rounded-xl border border-gray-300 dark:border-gray-700">
            <img
              src="/image1.png"
              alt="Gen Predicts prediction market interface"
